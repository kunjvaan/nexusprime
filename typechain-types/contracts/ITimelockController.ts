...
export interface ITimelockControllerInterface extends Interface {
...
export interface ITimelockController extends BaseContract {
  connect(runner?: ContractRunner | null): ITimelockController;
