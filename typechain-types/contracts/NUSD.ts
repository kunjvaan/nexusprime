...
export interface NUSDInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "totalSupplyWithDecimals",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface NUSD extends BaseContract {
  connect(runner?: ContractRunner | null): NUSD;
  ...
  totalSupplyWithDecimals: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "totalSupplyWithDecimals"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
